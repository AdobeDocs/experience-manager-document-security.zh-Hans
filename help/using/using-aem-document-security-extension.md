---
title: 使用AEM Document Security Extension for Microsoft&reg； Office
...
如果启用了自动应用策略，Document Security Extension for ® Office将提示您登录Document Security服务器。 输入您的用户名和密码，以便服务器可以验证您的身份。 如果提供了正确的登录凭据，则将保存并保护该文档。
